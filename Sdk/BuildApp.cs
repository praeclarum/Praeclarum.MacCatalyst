...
namespace  MacCatSdk
{
    public class BuildApp
    {
        ...
        string PROJDIR="/Users/fak/Dropbox/Projects/Catalyst/Research/Hello.iOS";
        string APP_DIR="Hi.app";
        ...
        async Task CompileBinaryAsync ()
        {
            ...
            // COMPUTED VARIABLED
            string CFLAGS="-target x86_64-apple-ios13.6-macabi -Wno-unguarded-availability-new -std=c++14 -ObjC";
            ...
            string OUT=$"{APP_DIR}/Contents/MacOS/{APPNAME}";
        ...
        void CopyAssemblies ()
        {
            string ASSEMBLIES_DIR=$"{PROJDIR}/obj/iPhone/Release/mtouch-cache/1-Link";
            string LINKED_ASSEMBLIES_DIR=$"{PROJDIR}/obj/iPhone/Release/mtouch-cache/3-Build";
            var asmsOutDir = Path.Combine(APP_DIR, "Contents", "MonoBundle");
